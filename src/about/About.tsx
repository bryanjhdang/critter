	...
	return (
		<>
			...
			<div className="justify-center">
				...
				<p>Mausritter is a rules-light fantasy adventure roleplaying game made by Losing Games, featuring a unique system of a physical card-based inventory system, and a heap of  home-brewed content made by the wonderful community.</p>
